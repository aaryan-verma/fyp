...
export default function Asset() {
  ...
  console.log(parseInt(data.issueTime));
  console.log(parseInt(data.warrantyPeriod));
        ...
        <RightSection>
          ...
          <AuthorContainer>
            ...
            <span>
              ...
              <UsernameEl>{data.owner}</UsernameEl>
            </span>
          </AuthorContainer>
          <EditionEl>Minter Box Edition</EditionEl>
          <span>
            <Title>{data.name}</Title>
            <MarketPlace>Product Warranty Marketplace</MarketPlace>
          </span>
          ...
          <WarrantyTime fromtime = {Date.now()} totime = {(parseInt(data.issueTime) + parseInt(data.warrantyPeriod)) * 1000}/>
